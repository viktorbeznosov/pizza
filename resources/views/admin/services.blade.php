                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-body">
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable order-column table-services" id="sample_1">
                                <thead>
                                <tr>
                                    <th>
                                ...
                                @foreach($services as $service)    
                                    ...
                                    <td class="center middle"> {{ $service->name }} </td>
